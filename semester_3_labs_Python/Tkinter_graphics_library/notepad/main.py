...
file_menu.add_command(label='Выход', command=close_notepad)
...
help_menu.add_command(label="Исполнитель Михеева Елизавета")
...
view_colors = {
    'dark': {
        'text_bg': 'black', 'text_fg': 'white', 'cursor': 'brown', 'select_bg': '#8D917A'
    },
    'light': {
