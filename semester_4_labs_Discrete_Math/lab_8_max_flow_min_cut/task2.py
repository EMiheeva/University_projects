...
print()
print("Вы ввели матрицу смежности: ")
for x in range(n):
        for y in range(n):
                print(graph[x][y], end=" ")
        print()
...
# Зададим случайные пропускные способности
new_graph = []
for i in range(n):
    row = []
    for j in range(n):
...
print()
print("Матрица смежности со случайными пропускными способностями: ")
for x in range(n):
        for y in range(n):
